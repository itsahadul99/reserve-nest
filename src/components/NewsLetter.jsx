      ...
      <div>
        ...
        <div className='w-full lg:w-1/2 text-center mx-auto'>
          ...
          <div className="join my-5">
            ...
            <button className="px-2 md:px-4 py-1 md:py-2 hover:bg-primary bg-secondary duration-300 rounded-md text-xs font-medium md:text-lg text-white">Subscribe</button>
          </div>
        </div>
      </div>
    </div>

                ...
                <div className="hero min-h-[calc(100vh-120px)]" style={{ backgroundImage: `url(${bg1})` }}>
                    ...
                    <div className="hero-content text-center text-white">
                        <div className="max-w-md">
                            ...
                            <Link to="/rooms" className="px-2 md:px-6 py-1 md:py-2 hover:bg-primary bg-secondary duration-300 rounded-md text-xs font-medium md:text-lg text-white">Book Room</Link>
                        </div>
                    </div>
                </div>
            </SwiperSlide>
